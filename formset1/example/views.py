...
def colorsname(request):
    ...
    return render(request, "colorradio.html", {"col" : result, "formset1" : form, "form2" : form2, "form3" : form3})
...
def colorsname2(request):
    ...
    form2 = hideshowshow(request.POST or None)
    form3 = col3form(request.POST or None)
    return render(request, "colorradio2.html", {"col" : result, "formset1" : form, "form2" : form2, "form3" : form3})
...
def userform(request):
    ...
    return render(request, 'userform.html', {'formset1' : form})

def playerform1(request):
    form = PlayerForm(request.POST or None)
    return render(request, 'playerform1.html', {'formset1': form})

def playerform2(request):
    form = PlayerForm2(request.POST or None)
    return render(request, 'playerform2.html', {'formset1': form})

def searchform(request):
    form = SearchForm(request.POST or None)
    return render(request, 'searchform.html', {'formset1' : form})

def hideshow(request):
    form = hideshowshow(request.POST or None)
    return render(request, 'hideshowshow.html', {'formset1': form})
"""
def colorsname(request):
    result = col.objects.all()
